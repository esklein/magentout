...
public interface ProductRemoteService extends GeneralService<Product> {
	...
	public abstract void setProductTypeConfigurable(Product product) throws ServiceException;

	public abstract void setSuperAttribute(Product product, ProductAttribute attribute) throws ServiceException;
