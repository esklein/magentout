...
public class ProductRemoteServiceTest {
	...
	public void testGetByIdAndSku() throws ServiceException {
		...
		Product productBySku = service.getById(1573);
		assertTrue(productBySku != null);

		System.out.println(productBySku.toString());
	}
	...
	@Test
	public void testSetProductType() throws ServiceException {
	    Product product = service.getBySku("049449");
	    //service.save(product);

	    assertTrue(product.getId() != null);
	    
	    service.setProductTypeConfigurable(product);
	    
	    System.out.println(product.getId());
	}
	
	@Test
	public void testSetSuperAttribute() throws ServiceException {
	    //service.setSuperAttribute(generateProduct());
	}
